...
//    cin >> f0 >> f1;     // reads 2 fractions, ex 8/5 12/16
   ...
   fraction::outputFormat(fraction::improper); // set output format to improper fraction
   cout << f4 << endl;     // outputs 16/8
   cout << f3 << endl;     // outputs 23/8
   cout << f1 << endl;     // outputs -19/4

   fraction::outputFormat(fraction::decimal); // set output format to decimal value
   cout << f3 << endl;     // outputs 2.875
   cout << f2 << endl;     // outputs 0.5
   cout << f1 << endl;     // outputs -4.75

   fraction::outputFormat(fraction::mixed); // set output format back to default mixed
